...
public class Tejido <T> {
  private ListaVertice<T> lista_vertices=new ListaVertice<T>();
	...
	public Lista<T> Camino(Tejido<T>g, int v1, int v2){
		int menor;
	...
	public int SiguienteVertice(Tejido<T> g,int costo[],int num_elem){
	...
	public int[] Dijkstra(Tejido<T> g, int v){
